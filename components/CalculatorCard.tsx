    ...
    <div className="w-full bg-white rounded-2xl border border-slate-200 shadow-md p-5 md:p-6 transition-all">
      ...
      <div className="flex items-center justify-between pb-3 mb-4 border-b border-slate-100">
        <span className="text-xs font-bold uppercase tracking-wider text-brand-600 bg-brand-50 px-2.5 py-1 rounded-md">
          {regionName ? `${regionName} ${taxName}` : taxName} Calculator
        </span>
      ...
      {/* Mode Switcher Tabs */}
      {!hideModeSwitcher && (
        <div className="flex flex-wrap items-center gap-1.5 border-b border-slate-100 pb-3 mb-5">
          <button
          ...
          <>
            ...
            <div>
              <label htmlFor="tax-rate-percentage-input-card" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1">
                {regionName ? `${regionName} ${taxName} Rate (%)` : `${taxName} Rate (%)`}
              </label>
              <div className="relative rounded-lg">
                <input
